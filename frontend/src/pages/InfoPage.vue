<template>
  ...
  <div>
    <div class="context">
      <h2>Інструкція по використанню:</h2>
      <ul>
        <li>Вводимо значення в поля:</li>
        <ul>
          <li>Обов’язково треба ввести поля:</li>
          <ul>
            <li>name project</li>
            <li>output file name</li>
            <li>the path to the file with the extension .jar</li>
            <li>the path to save file with the extension .exe</li>
            <li>path to Main class in file with extension .jar</li>
          </ul>
          <li>також можна додати іконку для застосунку та поставити галочку для створення ярлика на рабочему столі.</li>
        </ul>
        <li>Усі дані провалідуються і на разі помилок буде вказано саме де вони сталися.</li>
        <li>Тиснимо кнопку «Convert» і чикаємо повідомлення про успішне конвертування.</li>
        <li>Шукаємо застосунок в раніше зазначеній папці.</li>
        <li>При відкритті файла .exe буде доволі довго перевіряти антивірусник на віруси у застосунку, але все буде
          добре.
        </li>
        <li>Насолоджуємось.</li>
      </ul>
    </div>
    <div class="context">
      <div class="context-christmas-tree">
